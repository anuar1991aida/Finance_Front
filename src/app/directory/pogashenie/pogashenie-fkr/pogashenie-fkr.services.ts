...
export class PogasheniefkrService {
    ...
    fetch(params: any): Observable<pogashenie_fkr_list> {
        return this.http.get<pogashenie_fkr_list>(this.host + 'dirs/repayexplist', { params })
    }
