...
import { report_552_Service } from "./report_552.service";
...
@Component({
    selector: 'report_552',
    templateUrl: './report_552.html'
})

export class report_552_Component {
    constructor(
        private MainComponent: MainComponent,
        private reportComponent: reportComponent,
        private Report_552_config: DynamicDialogConfig,
        private Report_552_Service: report_552_Service,
        private sanitizer: DomSanitizer,
        private Report_552_msg: MessageService,
        private Report_552_ref: DynamicDialogRef,
        private Report_552_dialog: DialogService,
        private Report_552_confirm: ConfirmationService
    ) {
    ...
    selectBudjet() {
        this.Report_552_ref = this.Report_552_dialog.open(BudjetSelectComponent,
            {
        ...
        this.Report_552_ref.onClose.subscribe((budjet_detail: Budjet_detail) => {
            if (budjet_detail) {
