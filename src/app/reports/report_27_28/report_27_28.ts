...
import { report_27_28_Service } from "./report_27_28.service";
...
@Component({
    selector: 'report_27_28',
    templateUrl: './report_27_28.html'
})

export class report_27_28_Component {
    constructor(
        private MainComponent: MainComponent,
        private reportComponent: reportComponent,
        private Report_27_28_config: DynamicDialogConfig,
        private Report_27_28_Service: report_27_28_Service,
        private sanitizer: DomSanitizer,
        private Report_27_28_msg: MessageService,
        private Report_27_28_ref: DynamicDialogRef,
        private Report_27_28_dialog: DialogService,
        private Report_27_28_confirm: ConfirmationService
    ) {
    ...
    ngOnInit() {
        this.doc = this.Report_27_28_config.data.doc || ''
    }

    selectDoc() {
        this.Report_27_28_ref = this.Report_27_28_dialog.open(IzmIncDocListComponent,
            {
        ...
        this.Report_27_28_ref.onClose.subscribe((doc: izm_inc_doc) => {
            if (doc) {
                this.doc.id = doc.id,
