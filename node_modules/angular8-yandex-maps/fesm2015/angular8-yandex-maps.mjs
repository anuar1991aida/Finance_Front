...
class YaGeoObjectDirective {
    ...
    ngOnDestroy() {
        var _a, _b;
        if (this.geoObject) {
            (_b = (_a = this.yaMapComponent) === null || _a === void 0 ? void 0 : _a.map$.value) === null || _b === void 0 ? void 0 : _b.geoObjects.remove(this.geoObject);
            this.eventManager.destroy();
        }
        this.destroy$.next();
        this.destroy$.complete();
...
class YaPlacemarkDirective {
    ...
    ngOnDestroy() {
        var _a, _b;
        if (this.placemark) {
            (_b = (_a = this.yaMapComponent) === null || _a === void 0 ? void 0 : _a.map$.value) === null || _b === void 0 ? void 0 : _b.geoObjects.remove(this.placemark);
            this.eventManager.destroy();
        }
        this.destroy$.next();
        this.destroy$.complete();
...
class YaControlDirective {
    ...
    ngOnDestroy() {
        var _a, _b;
        if (this.control) {
            (_b = (_a = this.yaMapComponent) === null || _a === void 0 ? void 0 : _a.map$.value) === null || _b === void 0 ? void 0 : _b.controls.remove(this.control);
        }
        this.destroy$.next();
        this.destroy$.complete();
    }
...
class YaMultirouteDirective {
    ...
    ngOnDestroy() {
        var _a, _b;
        if (this.multiroute) {
            (_b = (_a = this.yaMapComponent) === null || _a === void 0 ? void 0 : _a.map$.value) === null || _b === void 0 ? void 0 : _b.geoObjects.remove(this.multiroute);
            this.eventManager.destroy();
        }
        this.destroy$.next();
        this.destroy$.complete();
...
class YaObjectManagerDirective {
    ...
    ngOnDestroy() {
        ...
        if (this.objectManager) {
            (_b = (_a = this.yaMapComponent) === null || _a === void 0 ? void 0 : _a.map$.value) === null || _b === void 0 ? void 0 : _b.geoObjects.remove(this.objectManager);
            this.eventManager.destroy();
        }
        this.destroy$.next();
        this.destroy$.complete();
